...
export const metadata = constructMetadata({
    title: 'FAQ | Charminar Repairs – Common Questions Answered',
...
export default function FAQPage() {
    return (
        <main style={{ background: '#f8f9fc' }}>
            <PageHero title="Frequently Asked Questions" subtitle="Everything you need to know about Charminar Repairs services, pricing, and policies." breadcrumb="FAQ" />
            ...
            <section style={{ padding: '60px 0 80px' }}>
                <div className="container" style={{ maxWidth: 960 }}>
                                ...
                                {section.items.map((item, i) => (
                                    <div key={i} style={{ background: '#fff', border: '1px solid #e8eaf0', borderRadius: 4, padding: '18px 22px' }}>
                                        <div style={{ fontWeight: 700, color: '#0c1228', fontSize: 15, marginBottom: 8, display: 'flex', alignItems: 'flex-start', gap: 10 }}>
                                            <span style={{ color: '#673ab7', fontWeight: 800, flexShrink: 0 }}>Q.</span>
                                            {item.q}
                                        </div>
                    ...
                    <div style={{ background: '#673ab7', borderRadius: 4, padding: '32px 36px', color: '#fff', textAlign: 'center', marginTop: 40 }}>
                        ...
                        <div style={{ display: 'flex', gap: 12, justifyContent: 'center', flexWrap: 'wrap' }}>
                            <a href="tel:8008615049" style={{ background: '#fff', color: '#673ab7', padding: '10px 24px', borderRadius: 4, fontWeight: 700, fontSize: 14, textDecoration: 'none' }}>Call 8008615049</a>
