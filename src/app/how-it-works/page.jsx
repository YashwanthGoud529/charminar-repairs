...
const steps = [
    { no: '01', title: 'Book Your Service', icon: '📱', color: '#673ab7', desc: 'Choose your appliance and preferred time slot. Book via website, phone call, or WhatsApp — takes less than 2 minutes. You\'ll receive an instant SMS/WhatsApp confirmation.' },
...
export default function HowItWorksPage() {
    return (
        <main style={{ background: '#f8f9fc' }}>
            <PageHero title="How It Works" subtitle="Getting your appliance repaired with Charminar Repairs is simple, fast, and fully transparent." breadcrumb="How It Works" />

            <section style={{ padding: '60px 0' }}>
                <div className="container" style={{ maxWidth: 1100 }}>
                    <div style={{ textAlign: 'center', marginBottom: 48 }}>
                        <span style={{ background: '#f3e8ff', color: '#673ab7', fontSize: 12, fontWeight: 700, padding: '4px 12px', borderRadius: 4, letterSpacing: 1 }}>THE PROCESS</span>
            ...
            <section style={{ background: '#fff', padding: '60px 0', borderTop: '1px solid #e8eaf0' }}>
                <div className="container" style={{ maxWidth: 1100 }}>
                    ...
                    <div style={{ textAlign: 'center', marginTop: 48 }}>
                        <Link href="/contact-us/" style={{ background: '#673ab7', color: '#fff', padding: '14px 36px', borderRadius: 4, fontWeight: 700, fontSize: 15, display: 'inline-block' }}>Book a Repair Now</Link>
                    </div>
                </div>
            </section>
        </main>
