        ...
        <section className={`home-it-setup-carousel py-5 ${bgClass}`} style={{ borderRadius: '4px' }}>
            <div className="container custom-container">
                <div className="d-flex align-items-center mb-4 gap-3">
                    ...
                    <span className="section-status-pill" style={{ background: '#0284c7', color: '#fff' }}>Expert IT Support</span>
                </div>
                ...
                <Swiper
                    ...
                    className="home-it-setup-swiper"
                >
                            ...
                            <Link href={service.slug} className="text-decoration-none">
                                <div className="shared-carousel-card most-booked-card hover-lift">
                                    <div className="img-wrapper safety-img-wrap" style={{ position: 'relative', height: '230px', marginBottom: '16px' }}>
                                        <div className="discount-tag" style={{ background: 'rgba(0, 0, 0, 0.75)', padding: '6px 12px', borderLeft: '4px solid #0284c7' }}>
                                            ...
                                            <span className="off-text" style={{ fontSize: '11px', color: '#0284c7' }}>{service.category || 'IT Support'}</span>
                                        </div>
