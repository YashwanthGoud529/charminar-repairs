...
const SafetyHomeProtection = ({ bgColor }) => {
    const parentService = SERVICE_DATA_MAP['Safety & Home Protection'];
    ...
    return (
        <section className={`safety-protection-carousel py-5 ${bgClass}`} style={{ borderRadius: '4px' }}>
            <div className="container custom-container">
                <div className="d-flex align-items-center mb-4 gap-3">
                    <h2 className="shared-carousel-title mb-0">Safety & Home Protection</h2>
                    <span className="section-status-pill" style={{ background: '#ff673a', color: '#fff' }}>Secure Your Space</span>
                </div>
                ...
                <Swiper
                    ...
                    className="safety-protection-swiper"
                >
                            ...
                            <Link href={service.slug} className="text-decoration-none">
                                <div className="shared-carousel-card most-booked-card hover-lift">
                                    <div className="img-wrapper safety-img-wrap" style={{ position: 'relative', height: '230px', marginBottom: '16px' }}>
                                        <div className="discount-tag" style={{ background: 'rgba(0, 0, 0, 0.75)', padding: '6px 12px', borderLeft: '4px solid #ff673a' }}>
                                            ...
                                            <span className="off-text" style={{ fontSize: '11px', color: '#ff673a' }}>{service.category || 'Setup'}</span>
                                        </div>
...
export default SafetyHomeProtection;
