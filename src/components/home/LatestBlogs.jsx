...
const LatestBlogs = () => {
    ...
    const LightbulbIcon = () => (
        <svg width="18" height="18" fill="currentColor" viewBox="0 0 24 24" className="text-orange">
    ...
    const ArrowRightIcon = () => (
        <svg width="14" height="14" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" className="ms-2">
        ...
        <section className="latest-blogs section-py">
            <div className="custom-container">
                <div className="d-flex align-items-center justify-content-between mb-5 flex-wrap gap-4">
                    ...
                    <Link href="/blog/" className="btn btn-outline-dark d-none d-md-flex align-items-center px-4 py-2 view-more-btn" style={{ borderRadius: '10px', height: 'fit-content' }}>
