...
const PremiumPestControl = ({ bgColor }) => {
    const parentService = SERVICE_DATA_MAP['Premium Pest Control Options'];
    ...
    return (
        <section className={`premium-pest-carousel py-5 ${bgClass}`} style={{ borderRadius: '4px' }}>
            <div className="container custom-container">
                <div className="d-flex align-items-center mb-4 gap-3">
                    <h2 className="shared-carousel-title mb-0">Premium Pest Control Options</h2>
                    <span className="section-status-pill" style={{ background: '#16a34a', color: '#fff' }}>Odorless & Safe</span>
                </div>
                            ...
                            <Link href={service.slug} className="text-decoration-none">
                                <div className="shared-carousel-card most-booked-card hover-lift">
                                    <div className="img-wrapper safety-img-wrap" style={{ position: 'relative', height: '230px', marginBottom: '16px' }}>
                                        <div className="discount-tag" style={{ background: 'rgba(0, 0, 0, 0.75)', padding: '6px 12px', borderLeft: '4px solid #16a34a' }}>
                                            ...
                                            <span className="off-text" style={{ fontSize: '11px', color: '#16a34a' }}>{service.category || 'Pest Control'}</span>
                                        </div>
...
export default PremiumPestControl;
